...
load_completed_games <- readRDS("Simulation Backup/Functions/load_completed_games.rds")
...
gt_dante_title <- readRDS('Simulation Backup/Functions/gt_dante_title.rds')
